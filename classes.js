...
let devan = new Employee('dev', 'ske', 'defva', 20);
let newHire = new Employee('john', 'day', 'jd@ds.com', 24);
...
class Machine{
  ...
  makeWidgets(num){
    ...
    this.wear_and_tear_count = (this.widgets_made_count - (this.widgets_made_count % 50)) / 50;
  }
  fixMachine(){
